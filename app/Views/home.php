...
<section class="hero">
    <div class="hero-ad">
        ...
        <p class="hero-program-name my-3">Beta Software Program <br />
            <span class="">IronPDF for C++</span>
        </p>
        <p class="coming-soon fw-light fs-7 mb-5">Coming soon</p>

        <img src="<?= base_url('images/PDF_Illustration.svg') ?>" class="pdf-illu" alt="pdf-illu" />
        <img src="<?= base_url('images/c_2plus_icon.svg') ?>" class="c_2plus_icon" alt="c_2plus_icon" />
        <img src="<?= base_url('images/CPP.jpg') ?>" class="cpp" alt="cpp" />
    </div>
</section>

<section class="email-signup">
    <div class="">
        <h1 class="heading">Be one of the first</h1>
...
<section class="reason">
    <div class="custom-container d-flex flex-lg-row flex-column align-items-center">
        ...
        <div class="text-center text-lg-start">
            <h1 class="heading">Why make a C++ PDF Library</h1>
...
<section class="early-access">
    <div class="custom-container position-relative py-5">
        <h1 class="heading text-center text-lg-start">Early Access to <span>C++ PDF Library</span></h1>
...
<section class="sign-up-beta-program">
    <div class="custom-container d-flex flex-column align-items-center py-5">
        <h1 class="heading2 get-license-text text-center text-md-start">Sign up to our <span class="">Beta Program</span></h1>
